...
$plugin->version = 20230120;  // YYYYMMDDHH (Year Month Day 24-hr time). // YYYYMMDDHH (The release version of Moodle 4.1).
$plugin->component = 'local_users'; // Name of your plugin (used for diagnostics).
